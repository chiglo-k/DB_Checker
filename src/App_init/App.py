...
class Init:
    ...
    def page_5(self):
        """Реестр учета счетов Феско/Дальрефтранс"""
    ...
    def run_app(self):
        ...
        with st.spinner('Ожидаем обработку данных...'):
            if page == "Инфо":
                ...
                st.caption('Анализ пропусков данных: просмотр коносаментов на пропуски в данных')
                st.caption('Реестр внутренний рынок: Дубликаты в номерах договоров, текущие номера договоров')
